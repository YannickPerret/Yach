...
const Dashboard = () => {
    ...
    const [calendarClassification, setCalendarClassification] = useState('PERSONAL');
    const [calendarClassVisibility, setCalendarClassVisibility] = useState('PUBLIC');
    ...
    const handleCheckboxChange = (e) => {
        if (e.target.checked) {
            ...
            setSelectedCalendars(prevState => prevState.filter(id => id !== e.target.value));
        }
    };
    ...
    return (
        <>
            ...
            <div>
                ...
                <button type="button" onClick={() => window.location.href = `/users/${username}/calendars`} id="showMyCalendar">See my calendars</button><br />
                <button type="button" onClick={() => createNewCalendar()}>Create empty calendar</button><br />
                ...
                <form method="post" encType="multipart/form-data" onSubmit={(e) => submitForm(e)}>
                    ...
                    <label>Upload calendar : </label><input type="file" name="file" id="file" onChange={(e) => setCalendarFile(e.target.value)}/><br />
                    <label htmlFor="pathUrl">Or by URL</label>
                    <input type="text" name="calendarUrl" id="pathUrl" placeholder='https://exemple.com/calendar.ics' onChange={(e) => setCalendarUrl(e.target.value)} /><br />
                    <label>Calendar classification : </label>
                    <select name="classification" onChange={(e) => setCalendarClassification(e.target.value)}>
                        <option value="PERSONAL">Personal</option>
                        <option value="PROFESSIONAL">Professional</option>
                        <option value="OTHER">Other</option>
                    </select><br />
                    <label>Calendar Privacy : </label>
                    <select name="class_visiblity" onChange={(e) => setCalendarClassVisibility(e.target.value)}>
                        <option value="PUBLIC">Public</option>
                        <option value="PRIVATE">Private</option>
                    </select><br />
                    <label>Calendar name : </label><input type="text" name="name" id="name" onChange={(e) => setCalendarTitle(e.target.value)} /><br /><br />
                            ...
                            <>
                                ...
                                .map(calendar => {
                                    switch (calendar.classification) {
                                        ...
                                        case 'OTHER':
                                            return (
                                                <DashboardItem key={calendar.id} data={calendar} username={username} setSelectedCalendars={handleCheckboxChange} />
                                            );
                                        default:
                                            return null;
                                    }
